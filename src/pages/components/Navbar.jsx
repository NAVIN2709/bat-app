...
>
  <div className="max-w-7xl mx-auto px-5 py-3 flex items-center justify-between">
    ...
    <button
      className="
        bg-green-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-lg font-semibold
  ...
  {open && (
    <div className="sm:hidden bg-white px-5 pb-5 pt-2 shadow-md animate-slideDown overflow-x-hidden">
      <button
        className="
          w-full bg-green-600 text-white px-4 py-2 rounded-lg text-lg font-semibold
          transition duration-300 hover:bg-white hover:text-green-600
          hover:border hover:border-green-600 hover:scale-105
        "
      >
